            ...
            <div class="footer-main">
                ...
                <div class="brand-section">
                    ...
                    <div class="footer-contact-email">
                        <a href="mailto:hello@aetherbloom.group" class="footer-contact-link">hello@aetherbloom.group</a>
                    </div>
                    
                    <div class="footer-social-links">
                        <a href="https://www.facebook.com/aetherbloom.group/" class="footer-social-link" target="_blank" rel="noopener noreferrer" aria-label="<?php esc_attr_e('Follow us on Facebook', 'aetherbloom'); ?>">
                        ...
                        <a href="https://www.linkedin.com/company/aetherbloom-group/" class="footer-social-link" target="_blank" rel="noopener noreferrer" aria-label="<?php esc_attr_e('Follow us on LinkedIn', 'aetherbloom'); ?>">
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
